...
async def main(page: ft.Page):
    ...
    async def add_and_remove_an_blank_message(e):
        """
    ...
    async def steam_build_bot_message(respond, user_message):
        ...
        await add_and_remove_an_blank_message(None)  # to scroll to the bottom
...
ft.app(port=8551, target=main, view=ft.WEB_BROWSER, host="172.16.201.221")
# ft.app(target=main)
